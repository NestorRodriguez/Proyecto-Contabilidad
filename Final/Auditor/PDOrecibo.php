<?PHP
    ...
    class AlumnoModel
    {
        ...
        public function Obtener($idRecibo)
        {
            try 
            {
                $stm = $this->pdo
                        ->prepare("SELECT * FROM recibo WHERE idRecibo = ?");
                        

                $stm->execute(array($idRecibo));
        ...
        public function Eliminar($idRecibo)
        {
            ...
            {
                $stm = $this->pdo
                        ->prepare("DELETE FROM recibo WHERE idRecibo = ?");                      
        ...
        public function Registrar(Alumno $data)
        {
            try 
            {
            $sql = "INSERT INTO recibo (idUser,fecha,responsable,nit,valor,bmil,bdosmil,bcincomil,bdiezmil,bveintemil,bcincuentamil,mcincuenta,mcien,
